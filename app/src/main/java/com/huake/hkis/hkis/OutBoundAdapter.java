...
class OutBoundAdapter extends RecyclerView.Adapter<OutBoundAdapter.SimpleViewHolder> {
    ...
    public OutBoundAdapter(Context context, List<Task> datas) {
    ...
    public SimpleViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        SimpleViewHolder holder = new SimpleViewHolder(LayoutInflater.from(
                context).inflate(R.layout.fragment_down_outbound_item, parent,
                false));
        return holder;
    }
