...
import com.huake.hkis.hkis.OutboundSumActivity;
...
public class DownFragment2 extends Fragment {
    ...
    public void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        View popupView = getLayoutInflater(savedInstanceState).inflate(R.layout.down_pop_window, null);
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        View fv = inflater.inflate(R.layout.fragment_down, container, false);
        ...
        downBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                fListener.onFragmentAction(params,OutboundSumActivity.class);
