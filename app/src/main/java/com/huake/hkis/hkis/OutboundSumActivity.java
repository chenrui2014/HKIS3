...
public class OutboundSumActivity extends AppCompatActivity  implements LifecycleRegistryOwner,OutBoundAdapter.OnItemClickListener {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        docTypeTV.setText(documentsType);
...
//        refreshLayout.setRefreshEnable(false);
    ...
    private LiveData<List<Task>> getData(){
        ...
        LiveData<List<Task>> taskData = hkisRep.getTask(userId,TASK_TYPE_DOWN,taskNO,documentsType,wareHouseNO,inDate,page,PAGE_SIZE);
        return taskData;
    }
    ...
    protected void initData() {
        ...
        docNOData.observe(OutboundSumActivity.this,docNOList->{
            docNOPv.setData(docNOList);
        });

        LiveData<List<String>> wareHouseNOData = hkisRep.warehouseList();
        wareHouseNOData.observe(OutboundSumActivity.this,wareHouseNOList->{
