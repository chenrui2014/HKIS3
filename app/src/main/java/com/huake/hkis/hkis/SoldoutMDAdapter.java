...
class SoldoutMDAdapter extends RecyclerView.Adapter<SoldoutMDAdapter.SimpleViewHolder> {
    ...
    public SoldoutMDAdapter(Context context, List<ShelvesDetail> datas) {
    ...
    public SimpleViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        SimpleViewHolder holder = new SimpleViewHolder(LayoutInflater.from(
                context).inflate(R.layout.fragment_down_material_detail, parent,
                false));
        return holder;
    }
