...
public class InventoryMSMDActivity extends AppCompatActivity  implements LifecycleRegistryOwner,InventoryMSMDAdapter.OnItemClickListener {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        backImg.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                intent.setClass(InventoryMSMDActivity.this, InStoreSummaryActivity.class);
                startActivity(intent);
                InventoryMSMDActivity.this.finish();
            }
        });
        ...
        confirmTv.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                for(Integer i = 0; i < selectItems.size(); i++){
                    selectShelvesDetail.add(checkDetail.get(selectItems.get(i)));
                }

                Intent intent = new Intent();
                intent.setClass(InventoryMSMDActivity.this,MaterialShelvesActivity.class);
    ...
    private void initRecyclerView() {
        ...
        adapter = new InventoryMSMDAdapter(this, checkDetail);
